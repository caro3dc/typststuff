...
#let sd(author, subject, title, code, cs, mode, font, fz, doc) = {
  ...
  let head = [#par(
      leading: 0.67em,
        ...
        #h(1fr)
        #box(fill: wda, inset: (x: 0.33em, y:0em), outset: (y: 0.33em), radius:(0.33em))[#text(fill:tc)[#smallcaps[#strong[#wd · #sadaveAnCon]]]]
        #linebreak()
        #box(
          fill: maingrad,
          ...
          outset: (y: 0.33em),
          radius: 0.33em,
        )[#text(fill: bg)[#strong[#smallcaps[#subject] · #title]]]
        #h(1fr)
        #box(
          fill: la,
          inset: (x: 0.33em, y: 0em),
    ...
    if (footer) {
      ...
      #line(length: 100%, stroke: 1pt + color.mix(tc, bg))
       #box(
          ...
          outset: (y: 0.33em),
          radius: 0.33em,
        )[#text(fill: bg, size: fs)[#strong[#code]]] · #box(fill: wda, inset: (x: 0.33em, y:0em), outset: (y: 0.33em), radius:(0.33em))[#text(fill:tc)[#smallcaps[#strong[#wd · #sadaveAnCon]]]]
        #h(1fr)
  ...
  show heading.where(level: 1): hy => [
    ...
    #align(center, block(inset: 0.33em, radius: 0.25em, width: 100%, fill: tc, smallcaps[#hy]))
  ]
  ...
  show heading.where(level: 4): hy => [
    ...
    #parbreak()
    #text()[#[#smallcaps[#hy]]<bgla>] #sym.space
  ]

  show heading.where(level: 5): hy => [
    #set text(fill: da, size: 1em)
    #parbreak()
    #text()[#[#smallcaps[#hy]]<2bgla2>] #sym.space
  ]

  show heading.where(level: 6): hy => [
    #set text(fill: ac, size: 1em)
    #parbreak()
    #text()[#[#smallcaps[#hy]]<3bgla2>] #sym.space
  ]
